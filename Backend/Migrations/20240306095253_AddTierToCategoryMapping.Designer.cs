...
namespace PDPWebsite.Migrations
{
    ...
    [Migration("20240306095253_AddTierToCategoryMapping")]
    partial class AddTierToCategoryMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PDPWebsite.Models.Tier", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PDPWebsite.Models.Resource", b =>
                {
                    ...
                    b.HasOne("PDPWebsite.Models.Tier", "Tier")
                        .WithMany("Resources")
            ...
            modelBuilder.Entity("PDPWebsite.Models.Tier", b =>
                {
                    b.HasOne("PDPWebsite.Models.Category", null)
                        .WithMany("Tiers")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
